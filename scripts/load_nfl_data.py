...
# Team Info
team_info_df = nfl.import_team_desc()[['team_abbr', 'team_name', 'team_color']]
...
game_stats_summary_df.to_sql('nfl_game_stats_summary', sql_connection, if_exists='replace', index=False)
